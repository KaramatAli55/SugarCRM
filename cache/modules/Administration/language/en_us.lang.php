...
3) Click Schedule System Index. Make sure that crontab is set up to run cron.php. This will handle indexing as well as the fallback mechanism when the connection to the search engine is interrupted.',
  ...
  'LBL_LINK_NAME' => 'Example Link',
  'LBL_LINK_DESCRIPTION' => 'This will show an action of the student management module',
  'LBL_SECTION_HEADER' => 'Example of Admin Panel',
  'LBL_SECTION_DESCRIPTION' => 'will be use for the student management module',
);